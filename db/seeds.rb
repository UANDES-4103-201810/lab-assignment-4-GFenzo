...
place_1 = Place.create(name: 'Estadio Nacionalasdasfasfasa', address:'Av. Grecia 2001', capacity: 50000)
place_2 = Place.create(name: 'Teatro Caupolicanasdasdasdasda', address:'San Diego 850', capacity: 5000)
